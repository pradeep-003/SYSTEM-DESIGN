...
/*
Encapsulation.Encapsulation says 2 things:
...
public class Encapsulation {
    public static void main(String[] args) {
        ...
        // System.out.println("Current Speed of My Sports Abstraction.Car is set to " + mySportsCar.currentSpeed);

        System.out.println("Current Speed of My Sports Abstraction.Car is " + mySportsCar.getSpeed());
    }
}